    ...
    <div class="position-absolute top-50 start-50 translate-middle">
        <form action="/students" method="POST">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="cne" aria-label="readonly input example">
            </div>

            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">CIN</label>
                
                <input class="form-control" type="text" name="cin" aria-label="readonly input example">
            </div>
            ...
            <div class="mb-3">
                ...
                <input class="form-control" name="filiere" list="datalistOptions" id="exampleDataList" >
            ...
            <button type="submit" class="btn btn-outline-dark mb-2">Créer</button>
            <a href="/students" class="btn btn-outline-dark mb-2">Annuler</a>
        </form>
    </div>
</body>
</html>